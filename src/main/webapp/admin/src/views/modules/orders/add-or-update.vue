<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="商户名称" prop="mendianzhanghao">
          <el-input v-model="ruleForm.mendianzhanghao" 
              placeholder="商户名称" clearable  :readonly="ro.mendianzhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="商户名称" prop="mendianzhanghao">
              <el-input v-model="ruleForm.mendianzhanghao" 
...
export default {
  ...
  methods: {
	...
	this.ruleForm.logistics = this.ruleForm.logistics.replace(reg,'../../../ssm0cq5r/upload');
        } else {
