      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<el-form-item label="门店账号" class="input" v-if="tableName=='mendian'">
			  <el-input v-model="ruleForm.mendianzhanghao" autocomplete="off" placeholder="门店账号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='mendian'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="确认密码" class="input" v-if="tableName=='mendian'">
			  <el-input v-model="ruleForm.mima2" autocomplete="off" placeholder="确认密码" type="password"/>
			</el-form-item>
			...
			<el-form-item label="联系电话" class="input" v-if="tableName=='mendian'">
			...
			<el-form-item label="店铺地址" class="input" v-if="tableName=='mendian'">
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if((this.ruleForm.mima!=this.ruleForm.mima2) && `mendian` == this.tableName){
	    this.$message.error(`两次密码输入不一致`);
	    return
      }
