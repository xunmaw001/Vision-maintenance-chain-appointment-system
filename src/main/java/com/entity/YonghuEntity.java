...
public class YonghuEntity<T> implements Serializable {
	...
	private String mendianxingming;
	 ...
	 * 设置：门店姓名
	 */
	public void setMendianxingming(String mendianxingming) {
		this.mendianxingming = mendianxingming;
	}
	/**
	 * 获取：门店姓名
	 */
	public String getMendianxingming() {
		return mendianxingming;
	}
	/**
	 * 设置：余额
	 */
